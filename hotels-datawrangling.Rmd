...
hotels %>%
  ...
  select(hotel, lead_time, country)
```

### Exercise 3.

How many bookings involve at least 1 child **or** baby? Answer: 9,332.
...
hotels %>% 
  ...
  select(arrival_date_year, arrival_date_month, adults, children, babies)
```
